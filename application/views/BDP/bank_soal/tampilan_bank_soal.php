                                ...
                                ?>
                                    ...
                                    <td>
                                        <h5 class="text-center">
                                            <a class="btn btn-success btn-sm  text-uppercase" href="<?= base_url() ?>Dashboard_bdp/upload_banksoal/<?= $row['id_bank_soal'] ?>"><i class="fas fa-upload"></i></a>
                                            <a class="btn btn-primary btn-sm  text-uppercase" href="<?= base_url() ?>Dashboard_bdp/detail_banksoal/<?= $row['id_bank_soal'] ?>"><i class="fas fa-search"></i></a>
                                            <a class="btn btn-danger btn-sm  text-uppercase" href="<?= base_url() ?>Dashboard_bdp/hapus_bank_soal/<?= $row['id_bank_soal'] ?>"><i class="fas fa-trash"></i></a>
                                        </h5>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>Dashboard_bdp/simpan_bank_soal" method="post">
