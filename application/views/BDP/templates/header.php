    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Dashboard_bdp">
                <div class=" sidebar-brand-text mx-3 text-uppercase">ADMIN CBT <br>BDP
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_bdp/kelas">Master Kelas</a>
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_bdp/guru">Master Guru</a>
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_bdp/mata_pelajaran">Master Mapel</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>Dashboard_bdp/peserta_ujian">
                    <i class="fas fa-graduation-cap"></i>
                    <span>Peserta Ujian </span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>Dashboard_bdp/bank_soal">
                    <i class="fas fa-graduation-cap"></i>
                    <span>Bank Soal</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>Dashboard_bdp/jadwal_ujian">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_bdp/akun_peserta">Akun Peserta</a>
