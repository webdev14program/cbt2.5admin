<div class="card rounded">
    <div class="card-body bg-primary">
        <h4 class="text-white text-uppercase font-weight-bold">cbt 2.5 smk tunas harapan (admin OTKP)</h4>
    </div>
</div>
    ...
    <div class="col-sm mt-2">
        <div class="card">
            <div class="card-body bg-success">
                <div class="row">
                    <div class="col">
                        <h3 class="text-white  font-italic font-weight-bold "><?= $bank_soal ?></h3>
                        <h4 class="text-white  font-italic font-weight-bold">Bank Soal</h4>
                    </div>
