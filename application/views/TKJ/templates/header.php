    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Dashboard_tkj">
                <div class=" sidebar-brand-text mx-3 text-uppercase">ADMIN CBT <br> TKJ
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/kelas">Master Kelas</a>
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/guru">Master Guru</a>
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/mata_pelajaran">Master Mapel</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>Dashboard_tkj/peserta_ujian">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>Dashboard_tkj/jadwal_ujian">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/akun_peserta">Akun Peserta</a>
