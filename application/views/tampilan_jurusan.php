        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-success btn-sm text-uppercase font-weight-bold" data-toggle="modal" data-target="#exampleModal">
                    <i class="fas fa-plus-square"></i> Upload Jurusan
                </button>
                <a class="btn btn-danger btn-sm text-uppercase font-weight-bold" href="<?= base_url() ?>Dashboard/hapus_all_jurusan"><i class="fas fa-trash"></i> Hapus Jurusan</a>
            </div>
        </div>
    </div>
</div>
